...
class Game():
    ...
    def render_info(self, pen, score, active_enemies = 0):
        ...
        character_pen.draw_string(pen, "COOL SPACE GAME", 400, 270)
...
character_pen.draw_string(pen, "Cool Space Game", 0, 160)

character_pen.scale = 1.0
character_pen.draw_string(pen, "By Noob Programmer Ronit", 0, 100)
